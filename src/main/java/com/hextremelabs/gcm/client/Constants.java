...
public final class Constants {
  ...
  /**
   * HTTP parameter for package name that can be used to restrict message delivery by matching against the package name
   * used to generate the registration id.
   */
  ...
  /**
   * A particular message could not be sent because the GCM servers encountered an error. Used only on JSON requests, as
   * in plain text requests internal errors are indicated by a 500 response.
   */
